...
export const ContentPreferences = [
  ...
  'Toileting',
  'Communication Tools & Alternatives (PECS, AAC)',
  'Feeding & Eating Support',
  'Activities of Daily Living',
  'Planning and Moving (Motor Planning)',
  'Walking, Balance & Moving Safely'
];

// Areas of expertise for clinicians
...
export const clinicianTypes = [
  ...
  { value: 'LBA', label: 'LBA' },
  { value: 'BCBA/LBA', label: 'BCBA/LBA' },
  { value: 'SLP', label: 'SLP' },
  { value: 'CCC-SLP', label: 'CCC-SLP' },
  { value: 'OTR', label: 'OTR' },
  { value: 'OT/L', label: 'OT/L' },
  { value: 'OTR/L', label: 'OTR/L' },
  { value: 'PT', label: 'PT' },
  { value: 'DPT', label: 'DPT' }
];

// Specializations for dropdown (keeping the existing structure)
