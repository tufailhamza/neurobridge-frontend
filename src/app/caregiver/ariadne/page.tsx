    ...
    <div className="h-screen bg-d">
      ...
      <div className="ml-64 h-full flex flex-col overflow-hidden">
        ...
        <div className="pt-4 pr-4 pb-6 bg-white flex justify-between items-center">
          <h2 className="text-4xl  text-b font-black ">Ariadne</h2>
        </div>
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="w-80 bg-white border border-gray-200 rounded-xl flex flex-col">
            ...
            <div className="p-4  border-gray-200">
             <button className="w-full flex items-center justify-center space-x-2 px-4 py-2 bg-blue-400 text-white rounded-lg hover:bg-blue-500 transition-colors">
                <Plus size={16} />
                <span>New Chat</span>
              </button>
            </div>
