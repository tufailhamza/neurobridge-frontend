...
export default function CaregiverSidebar() {
  ...
  useEffect(() => {
    ...
    } else if (pathParts.includes('home') || pathname === '/caregiver' || pathname === '/caregiver/') {
      setActiveItem('home');
    } else {
  ...
  useEffect(() => {
    try {
      ...
      if (userMetadata) {
        ...
        setUserInfo({
          firstName: parsed.first_name || 'Jane',
          lastName: parsed.last_name || 'Smith',
          ...
          <div className="space-y-2">
            ...
            >
              {userInfo.profileImage ? (
                ...
                <div className="w-8 h-8 rounded-full bg-b flex items-center justify-center">
