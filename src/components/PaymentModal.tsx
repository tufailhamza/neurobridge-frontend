    ...
    <div className="fixed inset-0 bg-black/30 bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
        ...
        <div className="flex items-center justify-between px-6 pt-6">
          <div>
            <h2 className="text-xs text-gray-600">Purchase</h2>            
          </div>
          <button
            onClick={onClose}
        ...
        <div className="px-6 pb-6">
            <p className="text-xl text-b font-bold py-2">{contentTitle}</p>
          <div className="mb-6">
            <div className="flex items-center justify-between mb-2 mt-8">
              <span className="text-sm font-bold text-b">Total:</span>
              ...
              {savedCards.map((card) => (
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <button className="px-3 py-1 bg-a text-white text-sm rounded hover:a transition-colors">
                      Use
                    </button>
                  </div>
                </div>
